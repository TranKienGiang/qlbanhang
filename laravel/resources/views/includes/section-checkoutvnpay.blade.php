            ...
            <form action="#">
                <div class="row">
                    @if ($_GET['vnp_ResponseCode'] == '00')
                        <div id="formSentMsgSc" class="col-lg-8 col-md-6 alertmsg alert alert-success">
                            Thanh Toán Thành Công Vui Lòng Nhập Thông Tin Giao Hàng
                        </div>
                    @endif
                    ...
                    <!--<div class="checkout__input__checkbox">
                        ...
                        <input hidden type="text" class="payments" name="payments" @if ($_GET['vnp_ResponseCode'] == '00')
                                    value="1"
                                @else
                                    value="0"
                                @endif/>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="checkout__order">
                            ...
                            <button type="submit"  class="site-btn purchase">ĐẶT HÀNG</button>
                        </div>
                    </div>
                </div>
            </form>
