<x-admin>
	<div class="content">
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="card" id="container-day" data-list-month="{{$listMonth1}}" data-list-money-m="{{$arrTransactionYear}}" data-list-order-m="{{$arrTransactionYearOrder}}">
						...
						<div class="d-flex flex-row justify-content-end">
							<span class="mr-2">
								<i class="fas fa-square text-primary"></i> Biểu đồ doanh thu năm 2022
							</span>
							{{-- <span>
